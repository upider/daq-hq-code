...
static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_RequestMessage_2eproto[1];
static const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* file_level_enum_descriptors_RequestMessage_2eproto[1];
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_RequestMessage_2eproto = nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_RequestMessage_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_RequestMessage_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\024RequestMessage.proto\022\014message_pass\"\200\001\n"
  "\016RequestMessage\022-\n\003cmd\030\001 \001(\0162 .message_p"
  "ass.RequestMessage.CMD\022\013\n\003key\030\002 \001(\r\022\014\n\004s"
  "ink\030\003 \001(\t\"$\n\003CMD\022\007\n\003GET\020\000\022\007\n\003DEL\020\001\022\013\n\007RE"
  "COVER\020\002b\006proto3"
  ;
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_RequestMessage_2eproto_once;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_RequestMessage_2eproto = {
  false, false, 175, descriptor_table_protodef_RequestMessage_2eproto, "RequestMessage.proto", 
  &descriptor_table_RequestMessage_2eproto_once, nullptr, 0, 1,
  schemas, file_default_instances, TableStruct_RequestMessage_2eproto::offsets,
  file_level_metadata_RequestMessage_2eproto, file_level_enum_descriptors_RequestMessage_2eproto, file_level_service_descriptors_RequestMessage_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK ::PROTOBUF_NAMESPACE_ID::Metadata
descriptor_table_RequestMessage_2eproto_metadata_getter(int index) {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_RequestMessage_2eproto);
  return descriptor_table_RequestMessage_2eproto.file_level_metadata[index];
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_RequestMessage_2eproto(&descriptor_table_RequestMessage_2eproto);
namespace message_pass {
const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* RequestMessage_CMD_descriptor() {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_RequestMessage_2eproto);
  return file_level_enum_descriptors_RequestMessage_2eproto[0];
}
