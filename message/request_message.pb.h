...
#ifndef GOOGLE_PROTOBUF_INCLUDED_request_5fmessage_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_request_5fmessage_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_request_5fmessage_2eproto
...
struct TableStruct_request_5fmessage_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_request_5fmessage_2eproto;
...
class RequestMessage final :
 ...
 public:
  ...
  void set_sink(ArgT0&& arg0, ArgT... args);
  std::string* mutable_sink();
  PROTOBUF_FUTURE_MUST_USE_RESULT std::string* release_sink();
  void set_allocated_sink(std::string* sink);
  private:
  const std::string& _internal_sink() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_sink(const std::string& value);
...
void RequestMessage::set_sink(ArgT0&& arg0, ArgT... args) {
 
 sink_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void RequestMessage::_internal_set_sink(const std::string& value) {
  ...
  sink_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* RequestMessage::_internal_mutable_sink() {
  
  return sink_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* RequestMessage::release_sink() {
  // @@protoc_insertion_point(field_release:message_pass.RequestMessage.sink)
  return sink_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_request_5fmessage_2eproto
